...
class Service_catalog(models.Model):
    ...
    # service_type = fields.Selection([('catalog', 'Catalog'), ('pack', 'Package')],
    #                                 default='catalog', required=True, string="Service type")
...
class Services(models.Model):
    ...
    avatar_medium = fields.Binary(attachment=True,
                                  string='Avatar')
    avatar_small = fields.Binary(attachment=True)
    service_provider_id = fields.Many2one('service.provider', required=True,
                                          default=_default_provider, ondelete="cascade",
