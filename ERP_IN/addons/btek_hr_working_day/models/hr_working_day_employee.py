...
class HrWorkingDayEmployee(models.Model):
    _name = 'hr.working.day.employee'
    ...
    def write(self, values):
        self._check_state()
        return super(HrWorkingDayEmployee, self).write(values)

    @api.multi
    def unlink(self):
        self._check_state()
        return super(HrWorkingDayEmployee, self).unlink()
    ...
    def create(self, values):
        ...
        return super(HrWorkingDayEmployee, self).create(values)
